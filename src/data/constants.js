...
const GLOSSARY = [
  ...
  { term: "Constitutional AI", def: "An alignment approach where AI behavior is guided by a set of written principles (a 'constitution'). The AI evaluates its own outputs against these principles. Developed by Anthropic.", category: "Training" },
  ...
  { term: "Transformer Architecture", def: "The neural network architecture behind modern AI language models (GPT, Claude, etc.). Uses 'attention mechanisms' to process relationships between all parts of an input simultaneously.", category: "Capability" },
